  ...
  return (  
   ...
   <Text>
    ...
    <Text> 
        ...
        email: info@brightneighborhood.com
        </Highlight>  
    </Text>

        
    <Text maxW="50ch"> For any questions, queries, or information about our upcoming event on 'Lead in Our Water,' please contact us at: </Text>
    <Text> 
        <Highlight query="email" styles={{ px: '2', py: '1', rounded: 'full', bg: '#F4A460' }}> 
        email: cwa@brightneighborhood.com
        </Highlight>  
    </Text>
